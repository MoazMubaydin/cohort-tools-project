...
// Create a student
router.post("/students", isAuthenticated, (req, res) => {
...
router.patch("/students/:studentId", isAuthenticated, (req, res) => {
  const { studentId } = req.params;
...
router.delete("/students/:studentId", isAuthenticated, (req, res) => {
  const { studentId } = req.params;
